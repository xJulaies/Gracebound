...
import { formatBossSelectionLabel } from "../../../bosses/domain/formatBossSelectionLabel";
...
export function DamageTrialBossSelector({
  ...
  return (
    <section className="grid gap-5 border-t border-border pt-6" aria-labelledby="damage-trial-target-heading">
      <div>
      ...
      <label className="grid max-w-2xl gap-2" htmlFor="damage-trial-boss">
        <span className="font-heading text-sm text-accent">Boss</span>
        <select
          className="min-h-11 rounded-panel border border-border bg-background px-4 py-2 text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus"
          id="damage-trial-boss"
          onChange={(event) => {
