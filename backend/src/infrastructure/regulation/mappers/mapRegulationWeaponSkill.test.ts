  ...
  it("maps the verified standard Ashes of War from their 1.17 attack rows", () => {
    const standardTables = {
      ...
      behaviors: [
        ...
        { ...behavior(300000075, 75, 1, 2490), variationId: 0 },
        { ...behavior(300000330, 330, 1, 2130), variationId: 0 },
        { ...behavior(300000631, 631, 1, 2635), variationId: 0 },
        { ...behavior(300000634, 634, 1, 2636), variationId: 0 },
        { ...behavior(300000637, 637, 1, 2637), variationId: 0 },
      ...
      attacks: [
        ...
        { ...attack(300200075, 0, 230, 3, 1, 10000) },
        { ...attack(300200890, 0, 137, 3, 1, 10000) },
        { ...attack(300000631, 0, 0, 1, 1, 10000), atkPhys: 115 },
        { ...attack(300000634, 0, 0, 1, 1, 10000), atkPhys: 115 },
        { ...attack(300000637, 0, 0, 1, 1, 10000), atkPhys: 115 },
      ...
      swordArts: [
        ...
        swordArt(202, "Ice Spear", 15, -1),
        swordArt(203, "Glintstone Pebble", 8, 4),
        swordArt(224, "Blood Blade", 3, 3),
      ...
      bullets: [
        ...
        { ID: 2490, Name: "Ice Spear", atkId_Bullet: 300200075, intervalCreateBulletId: -1 },
        { ID: 2130, Name: "Glintstone Pebble", atkId_Bullet: 300200890, intervalCreateBulletId: -1 },
        { ID: 2635, Name: "Blood Blade", atkId_Bullet: 300000631, intervalCreateBulletId: -1 },
        { ID: 2636, Name: "Blood Blade", atkId_Bullet: 300000634, intervalCreateBulletId: -1 },
        { ID: 2637, Name: "Blood Blade", atkId_Bullet: 300000637, intervalCreateBulletId: -1 },
    ...
    expect(skills.flatMap(({ attacks: skillAttacks }) => skillAttacks)).toMatchObject([
      ...
      {
        fpCost: 15,
        components: [{ kind: "projectile", sourceBulletId: 2490, addedDamage: { magic: 230 } }],
      },
      {
        fpCost: 8,
        components: [{ kind: "projectile", sourceBulletId: 2130, addedDamage: { magic: 137 } }],
      },
      ...[2635, 2636, 2637].map((sourceBulletId) => ({
        fpCost: 3,
        components: [{ kind: "projectile", sourceBulletId, addedDamage: { physical: 115 } }],
      })),
      {
        fpCost: 9,
