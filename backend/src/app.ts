...
import { createBossImageAssetRouter } from "./features/assets/routes/bossImageAsset.routes";
import { createUiAssetRouter } from "./features/assets/routes/uiAsset.routes";
...
export function createApp(authentication: Authentication) {
  ...
  app.use("/api", createBossImageAssetRouter());
  app.use("/api", createUiAssetRouter());
