...
import type { ArmorData, ArmorSlot } from "./domain/armor.types";
...
describe("public armor API", () => {
  it("returns selection and calculation data without Regulation internals", async () => {
    ...
    expect(response.body.data[0]).toMatchObject({ id: "vagabond-knight-armor", slot: "body", hasPassiveEffects: false });
